    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-10">
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc pl-5 space-y-2 text-foreground/90">
          <li>
            ...
            (et bientôt <code>.mdx</code>) — versionnés, normalisés, synchronisés en base, avec tags
            et recherche plein-texte.
          </li>
          <li>
          ...
          <li>
            <strong>Liens &amp; hypothèses</strong> : une écriture qui assume les connexions
            (backlinks <code>[[mot]]</code>, tags générés lorsque c’est utile), et documente les
            pistes autant que les résultats.
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>
            <strong>Contribuer</strong> (bientôt ouvert) : billets en Markdown, propositions
            d’édition, relectures et enrichissements.
          </li>
          <li>
            <strong>Publier</strong> : lorsque c’est mûr, un texte peut migrer vers la section{' '}
      ...
      <section className="space-y-3">
        ...
        <p className="text-foreground/90">
          Un espace dédié à l’édition de poésie : formes brèves, archives sonores, variantes,
          annotations collectives. L’atelier explorera l’édition en MDX (composants interactifs) et
          l’indexation par motifs.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>
            Billets : fichiers <code>.md</code> normalisés, synchronisés via Prisma vers PostgreSQL
            (Neon).
          </li>
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>
            Édition <code>MDX</code> : notes flottantes, citations actives, visualisations légères.
          </li>
